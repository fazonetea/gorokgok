...
Asena.addCommand({pattern: 'block ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.BLOCK_DESC}, (async (message, match) => {    
...
Asena.addCommand({pattern: 'unblock ?(.*)', fromMe: true, deleteCommand: false, desc: Lang.UNBLOCK_DESC}, (async (message, match) => {    
    if (message.reply_message !== false) {
